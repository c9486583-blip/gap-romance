    ...
    try {
      ...
      if (!error && data) {
        ...
        if (data.is_verified) {
          ...
          toast({ title: "🎉 You're verified!", description: "Your profile is now live on GapRomance." });
          navigate("/discover");
        }
      }
    } catch (e) {
        ...
        {isFailed ? (
          <>
            ...
            <p className="text-sm text-muted-foreground mb-8">
              Don't worry — you can try again with a clearer photo.
            </p>
          ...
          <>
            ...
            <h1 className="text-3xl font-heading font-bold mb-3">Verification in Progress</h1>
            <p className="text-muted-foreground mb-8 max-w-sm mx-auto">
              Your verification is being reviewed. This usually takes just a few minutes.
              We'll unlock your profile as soon as you're approved.
            </p>
            ...
            <p className="text-xs text-muted-foreground mt-6">
              This page auto-refreshes every 10 seconds. You can close this and come back later.
            </p>
          </>
        )}
      </motion.div>
